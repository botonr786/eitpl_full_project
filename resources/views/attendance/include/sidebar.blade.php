	...
	<div class="sidebar-wrapper scrollbar scrollbar-inner">
	   <div class="sidebar-content">
		  ...
		  <ul class="nav nav-primary">
			 ...
			 <li class="@if (Request::Segment(2)=='add-montly-attendance-data-all')  submenu @endif nav-item ">
				<a data-toggle="collapse" href="#sidebarLayouts">
				   <i class="fas fa-user"></i>
				   <p>Attendance Management </p>
				   <span class="caret"></span>
				</a>
				<div class="collapse  @if (Request::Segment(2)=='add-montly-attendance-data-all')  active_show @endif " id="sidebarLayouts" >
			 ...
			 <li class="nav-item @if (Request::Segment(2)=='report-monthly-attendance')  @endif">
