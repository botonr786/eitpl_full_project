...
<option value="Business Bank statement for 2 Month"  >Business Bank statement for 2 Month</option>
										...
										<div class="col-md-4">
										  <div class="form-group">
												...
												<a style="margin-left:5px; top:0;" href="{{ asset('public/assets/img/PAYEE And Account Reference Letter From HMRC.pdf')}}" target="_blank"   class="sampleupload">Sample Document</a>
