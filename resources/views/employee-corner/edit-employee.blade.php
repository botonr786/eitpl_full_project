                                       ...
                                       <form id="regForm" action="{{url('employee-corner/update-profile')}}" method="POST" enctype="multipart/form-data">
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                   <div class="form-check">
                                                      ...
                                                      <input class="form-radio-input" type="radio" name="cur_pass" value="Yes" >
                                          ...
                                          ?>
                                                   @if($value->head_type == 'earning')
                                                                     ...
                                                                     <td><button class="btn-success cmn_bg_style" type="button" id="addearn<?php echo ($tr_id + 1); ?>" onClick="addnewrowearn(<?php echo ($tr_id + 1); ?>)" data-id="earn<?php echo ($tr_id + 1); ?>"> <i class="fas fa-plus"></i> </button></td>
                                                                          </tr>
                                                        @endif
