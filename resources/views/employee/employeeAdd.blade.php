                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="card custom-card">
                           ...
                           <div class="card-body new_btn_style">
                                             ...
                                             <div class="row">
                                                <div class="col-md-4">
                                                   <div class="form-group">
                                                      ...
                                                      <input type="text"  placeholder="Employee Code..." class="form-control"   name="emp_old_code" id="emp_old_code" oninput="this.value = this.value.toUpperCase()"></p>
                                                   </div>
                                                </div>
                                                <div class="col-md-4">
                                                   <div class="form-group">
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-md-12 p-0">
                                                      <div class="d-flex flex-row">
                                                          <div class="p-2">If address is same ?</div>
                                                          <div class="p-2"><input type="checkbox" onclick="presentFunc()"></div>
                                                       </div>
                                                </div>
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                   <div class="form-group">
                                                      ...
                                                      <input id="inputFloatingLabeliemail" type="email" class="form-control input-border-bottom" name="hel_em_email">
                                                   </div>
                                                </div>
                                                <div class="col-md-4">
                                                   <div class="form-group">
                                                      <label for="inputFloatingLabeliem" class="placeholder">Emergency Contact No.</label>
                                                      <input id="inputFloatingLabeliem" type="text" class="form-control input-border-bottom" name="hel_em_phone" >
                                                   </div>
                                                </div>
                                                <div class="col-md-4">
                                                   <div class="form-group">
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                   <div class="form-group">
                                                      ...
                                                      <input id="pass_review_date" type="text" class="form-control input-border-bottom" readonly name="pass_review_date">
                                                   </div>
                                                </div>
                                                <div class="col-md-4">
                                                   <div class="form-group">
                                                ...
                                                <table border="1" class="table table-bordered table-responsove" style="border-collapse:collapse;overflow-x:scroll;">
                                                   ...
                                                   <tbody id="marksheetearn">
                                                      <tr class="itemslotpayearn" id="0">
                                                         ...
                                                         <td>
                                                            <button class="btn-success cmn_bg_style" type="button" id="addearn1" onClick="addnewrowearn(1)" data-id="earn1"> <i class="fas fa-plus"></i> </button>
                                                         </td>
                                                      </tr>
                                                   </tbody>
                                                </table>
                                                ...
                                                <table border="1" class="table table-bordered table-responsove" style="border-collapse:collapse;overflow-x:scroll;">
                                                   ...
                                                   <tbody id="marksheetdeduct">
                                                      <tr class="itemslotpaydeduct" id="0">
                                                         ...
                                                         <td><button class="btn-success cmn_bg_style" type="button" id="adddeduct1" onClick="addnewrowdeduct(1)" data-id="deduct1"> <i class="fas fa-plus"></i> </button></td>
                                                      </tr>
                                                   </tbody>
                                                </table>
                                             </div>
