					...
					<div class="row">
						<div class="col-md-12">
							<div class="card custom-card">
								<div class="card-header ps-3 pe-3">
                                ...
                                <div>
                                    ...
                                    <div class="mb-2">
                                       <a href="{{url('employeesadd')}}"><button class="btn cmn_bg_style"><i class="fas fa-plus"></i></button></a>
                                    </div>
                                </div>
            ...
            @foreach($bonas as $ratedtl)
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                         <td>{{ $ratedtl->emp_code }}</td>
                                        <td>{{ $ratedtl->old_emp_code }}</td>
                                        <?php
                                           $fullname = $ratedtl->salutation.' '.$ratedtl->emp_fname.' '.$ratedtl->emp_mname.' '.$ratedtl->emp_lname;
                                        ?>
                                        <td>{{ $fullname  }}</td>
