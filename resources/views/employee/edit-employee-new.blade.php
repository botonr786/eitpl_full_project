   ...
   <body>
                                    ...
                                    <div class="container-fluid">
                                       <form id="regForm" action="{{url('employee/update-profile')}}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="tab">
                                             ...
                                             <input type="hidden" value="<?php print_r($employee_rs->emp_code) ?>" placeholder="Employee Code..." class="form-control"   name="emp_code"></p>
                                             <div class="row">
                                                <div class="col-md-3">
                                                   <div class="form-group">
                                                      <label>Employee Code <span style="color: red">(*)</label>
                                                      <input type="text" style="text-transform: uppercase;"  placeholder="Employee Code..." class="form-control"   name="emp_old_code" id="old_emp_code" value="<?php print_r($employee_rs->old_emp_code) ?>"  readonly></p>
                                                   </div>
                                                </div>
                                                <div class="col-md-3">
                                                   <div class="form-group">
                                                   ...
                                                   <div class="form-group">
                                                      <label>Designation <span style="color:red">(*)</span></label>
                                                         <select class="form-control" id="rate_id" name="designation" required >
                                                            ...
                                                            <option value="{{$item->designation_name}}" <?php if($item->designation_name==$employee_rs->designation){?> selected="selected"<?php }?>>{{$item->designation_name}}</option>
                                                            @endforeach
                                                         </select>
                                                   </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                   <div class="form-group">
                                                      ...
                                                      <select name="employeetype" class="form-control" id="type" onchange="employeeFunc()" >
                                                         ...
                                                         <option value="{{$emp->employ_type_name}}" <?php if($emp->employ_type_name==$employee_rs->employeetype){?> selected="selected"<?php }?>>{{$emp->employ_type_name}}</option>
                                                         @endforeach
                                                ...
                                                <table border="1" class="table table-bordered table-responsove" style="border-collapse:collapse;overflow-x:scroll;">
                                                   ...
                                                   <tbody id="marksheet">
                                                      <tr class="itemslot" id="0">
                                                         ...
                                                         <td>
                                                            <button class="btn-success cmn_bg_style" type="button" id="add1" onClick="addnewrow(1)" data-id="1"> <i class="fas fa-plus"></i> </button>
                                                         </td>
                                                      </tr>
                                                   </tbody>
                                                   <?php } else { ?>
                                                      ...
                                                      <tr class="itemslot" id="0">
                                                         ...
                                                         <td>
                                                            <select class="form-control" name="emp_document_name[]">
                                                               <option></option>
                                                               @foreach($employee_eduction as $item)
                                                               <option value="{{$item->education_name}}">{{$item->education_name}}</option>
                                                               @endforeach
                                                            </select>
                                                         </td>
                                                         <td>
                                                         ...
                                                         <td><button class="btn-success cmn_bg_style" type="button" id="add1" onClick="accademinewrow(1)" data-id="1"> <i class="fas fa-plus"></i> </button></td>
                                                      </tr>
                                                   </tbody>
                                                    <?php } else { ?>
                                                      <tbody id="marksheet1">
                                                      ...
                                                      <tr class="itemslot" id="0">
                                                         ...
                                                         <td>
                                                            <select class="form-control" name="emp_document_name[]">
                                                               <option></option>
                                                               <option value="{{$item->emp_document_name}}" <?php if($item->emp_document_name==$item->emp_document_name){?> selected="selected"<?php }?>>{{$item->emp_document_name}}</option>
                                                            </select>
                                                         </td>
                                                         <td>
                                                ...
                                                <table border="1" class="table table-bordered table-responsove" style="border-collapse:collapse;overflow-x:scroll;">
                                                   ...
                                                   <tbody id="marksheet2">
                                                      <tr class="itemslot" id="0">
                                                         ...
                                                         <td><button class="btn-success cmn_bg_style" type="button" id="add1" onClick="proaddnewrow(1)" data-id="1"> <i class="fas fa-plus"></i> </button></td>
                                                      </tr>
                                                   </tbody>
                                                   <?php } else {?>
                                                    <tbody id="marksheet2">
                                                    ...
                                                    <?php if(sizeof($MiscDocuments) == 0) {?>
                                                     <tbody id="marksheet3">
                                                      <tr class="itemslot" id="0">
                                                         ...
                                                         <td><button class="btn-success cmn_bg_style" type="button" id="add1" onClick="Miscnewrow(1)" data-id="1"> <i class="fas fa-plus"></i> </button></td>
                                                      </tr>
                                                   </tbody>
                                                    <?php }else{ ?>
                                                     <tbody id="marksheet3">
                                          ...
                                          <div class="tab">
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                   <div class="form-group">
                                                      <label>Street No. and Name</label>
                                                      <input type="text" name="emp_ps_street_no" id="present_street_name" value="<?php print_r($employee_rs->emp_ps_street_no)?>"  class="form-control">
                                                   </div>
                                                </div>
                                                <div class="col-md-4">
                                                   <div class="form-group">
                                                      <label>Village</label>
                                                      <input type="text" id="emp_ps_village" name="emp_ps_village" value="<?php print_r($employee_rs->emp_ps_village)?>" class="form-control">
                                                   </div>
                                                </div>
                                                <div class="col-md-4">
                                                   <div class="form-group">
                                                      <label>City</label>
                                                      <input type="text" name="emp_ps_city" id="present_city" value="<?php print_r($employee_rs->emp_ps_city)?>" class="form-control">
                                                   </div>
                                                </div>
                                                <div class="col-md-4">
                                                   <div class="form-group">
                                                      <label>Post Office</label>
                                                      <input type="text" id="emp_ps_post_office" name="emp_ps_post_office" value="<?php print_r($employee_rs->emp_ps_post_office)?>" class="form-control">
                                                   </div>
                                                </div>
                                                <div class="col-md-4">
                                                   <div class="form-group">
                                                      <label>Police Station</label>
                                                      <input type="text" id="emp_ps_policestation" name="emp_ps_policestation" value="<?php print_r($employee_rs->emp_ps_policestation)?>" class="form-control">
                                                   </div>
                                                </div>
                                                <div class="col-md-4">
                                                   <div class="form-group">
                                                      <label>Pin Code <span style="color: red">(*)</span></label>
                                                      <input type="text" name="emp_ps_pincode" id="present_pincode" value="<?php print_r($employee_rs->emp_ps_pincode)?>" class="form-control" required>
                                                   </div>
                                                </div>
                                                <div class="col-md-4">
                                                   <div class="form-group">
                                                      <label>District</label>
                                                      <input type="text" id="emp_ps_dist" name="emp_ps_dist" value="<?php print_r($employee_rs->emp_ps_dist)?>" class="form-control">
                                                   </div>
                                                </div>
                                                <div class="col-md-4">
                                                   <div class="form-group">
                                                      <label>State <span style="color: red">(*)</span></label>
                                                      <input type="text" name="emp_ps_state" value="<?php print_r($employee_rs->emp_ps_state)?>" id="stat" class="form-control"> 
                                                   </div>
                                                </div>
                                                <div class="col-md-4">
                                                   <div class="form-group">
                                                      <label>Country</label>
                                                      <input type="text" name="emp_ps_country" id="emp_ps_country" value="<?php print_r($employee_rs->emp_ps_country)?>" class="form-control" >
                                                   </div>
                                                </div>
                                                <div class="col-md-4">
                                                   <div class="form-group">
                                                      <label>Mobile No.</label>
                                                      <input type="text" name="emp_ps_mobile" value="<?php print_r($employee_rs->emp_ps_mobile)?>" id="emp_ps_mobilea" class="form-control" >
                                                   </div>
                                                </div>
                                             </div>
                                                ...
                                                <div class="col-md-3">
                                                   <div class="form-check">
                                                      ...
                                                      <div class="d-flex flex-row">
                                                           <div class="p-2" style="width:25px;"> <label for="html">Yes</label></div>
                                                          <div class="p-2 mt-1"><input type="radio" id="html" name="cur_pass" value="Yes"></div>
                                                      </div>
                                                       <div class="d-flex flex-row">
                                                           <div class="p-2" style="width:25px;"> <label for="css">No</label></div>
                                                          <div class="p-2 mt-1"><input type="radio" id="css" name="cur_pass" value="No"></div>
                                                      </div>
                                                   </div>
                                                </div>
                                                <div class="col-md-3">
                                          ...
                                          if ($emp_pay_st->t_alws != '') {
                                              $arr_name[] = 't_alws';
                                              $arr_value['t_alws'] = $emp_pay_st->t_alws;
                                              $arr_type['t_alws_type'] = $emp_pay_st->t_alws_type;
                                          ...
                                          ?>
                                                   @if($value->head_type == 'earning')
                                                                     ...
                                                                     <button class="btn-success cmn_bg_style" type="button" id="addearn<?php echo ($tr_id + 1); ?>" onClick="addnewrowearn(<?php echo ($tr_id + 1); ?>)" data-id="earn<?php echo ($tr_id + 1); ?>"> <i class="fas fa-plus"></i> </button>
                                                                  @endif
                                                                    <button class="btn-danger deleteButtonearnedit" style="background-color:#E70B0E; border-color:#E70B0E;" type="button" id="delearnedit<?php echo $tr_id; ?>"  onClick="delRowearn(<?php echo $tr_id; ?>)"> <i class="fas fa-minus"></i> </button></td>
                                          ...
                                          ?>
                                                   @if($value->head_type == 'earning')
                                                                     ...
                                                                     <td><button class="btn-success cmn_bg_style" type="button" id="addearn<?php echo ($tr_id + 1); ?>" onClick="addnewrowearn(<?php echo ($tr_id + 1); ?>)" data-id="earn<?php echo ($tr_id + 1); ?>"> <i class="fas fa-plus"></i> </button>
                                                               </td>
                                                                          </tr>
                                                        @endif
                                       ...
                                       ?>
                                                ...
                                                @if($value->head_type == 'deduction')
                                                                  ...
                                                                  <button class="btn-success cmn_bg_style" type="button" id="adddeduct<?php echo ($tr_id + 1); ?>" onClick="addnewrowdeduct(<?php echo ($tr_id + 1); ?>)" data-id="deduct<?php echo ($tr_id + 1); ?>"> <i class="fas fa-plus"></i> </button>
                                                               @endif
                                       ...
                                       ?>
                                                ...
                                                @if($value->head_type == 'deduction')
                                                                  ...
                                                                  <td><button class="btn-success cmn_bg_style" type="button" id="adddeduct<?php echo ($tr_id + 1); ?>" onClick="addnewrowdeduct(<?php echo ($tr_id + 1); ?>)" data-id="deduct<?php echo ($tr_id + 1); ?>"> <i class="fas fa-plus"></i> </button></td>
                                                                       </tr>
                                                               @endif
                                                               </tbody>
                                                               </table>
      ...
      <script>
         ...
         var lastrow = $(".itemslotpayearn:last").attr("id");
               //alert(lastrow);
               var active_div = (lastrow);
               $('#delearnedit'+active_div).attr('disabled',false);
