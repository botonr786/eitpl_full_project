      ...
      <div class="page-inner">
         <div class="row">
            <div class="col-md-12">
               ...
               <div class="card-body modify_select">
                  ...
                  <form action="{{url('loans/save-loan')}}" method="post" enctype="multipart/form-data" onsubmit="return validate();">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <button type="submit" class="btn btn-info btn-sm padding_btn"><i class="fa fa-plus"></i>&nbsp;Save</button>
                           <button type="reset" class="btn padding_btn cmn_bg_style" onclick="select2_reset();"><i class="fa fa-ban"></i>&nbsp;Reset</button>
                        </div>
                     </div>
