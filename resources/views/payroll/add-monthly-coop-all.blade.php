            ...
            <div class="col-md-12">
               <div class="card custom-card">
                @include('layout.message')
                  <div class="card-body">
                    <form action="{{url('payroll/vw-add-coop-all')}}" method="post" enctype="multipart/form-data" style="width:100%;margin:0 auto;padding: 18px 20px 1px;background: #f4f4f4;" class="rounded pb-2">
                        {{ csrf_field() }}
                        <div class="row form-group">
                            ...
                            <div class="col-md-3">
                                <button type="submit" class="btn btn-info pe-2" style="color: #fff;background-color: #0884af;border-color: #0884af;padding: 0px 8px;
                height: 38px; width:45px;">Go</button>
                            </div>
                        </div>
                    </form>
                  </div>
