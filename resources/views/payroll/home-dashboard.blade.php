...
.hcm-icon.green{background:#01aef0;}
...
.hcm-name.green a img{background:#01aef0;}
             ...
             <div class="text-center col-lg-12" style="padding:0;">
                <div class="payroll-main">
                   <div class="row">
                      ...
                      <div class="col-md-4">
                         <div class="hcm  shadow bg-body rounded" style="margin: 40px 30px 40px 0;">
                            <div class="row">
                               <div class="col-md-4 col-4 pr0">
                                  <div class="hcm-icon green rounded">
                                     <img class="" src="{{ asset('theme/images/leave-application-icon2.png') }}" alt=""style="max-width:120px;">
                                  </div>
                               </div>
                               <div class="col-md-8 col-8 pl0">
                                  <div class="hcm-name green rounded">
                      ...
                      <div class="col-md-4">
                         <div class="hcm  shadow bg-body rounded" style="margin: 40px 30px 40px 0;">
                            <div class="row">
                               <div class="col-md-4 col-4 pr0">
                                  <div class="hcm-icon green rounded">
                                     <img class="" src="{{ asset('theme/images/leave-application-icon3.png') }}" alt=""style="max-width:120px;">
                                  </div>
                               </div>
                               <div class="col-md-8 col-8 pl0">
                                  <div class="hcm-name green rounded">
