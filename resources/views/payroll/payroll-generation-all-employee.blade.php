                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <form action="{{ url('payroll/vw-payroll-generation-all-employee') }}" method="post"
                                    ...
                                    style="width:50%;margin:0 auto;padding: 18px 20px 18px;background: #ecebeb;">
                                    {{ csrf_field() }}
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-3">
                                            <button type="submit" class="btn btn-info"
                                                style="color: #fff;background-color: #0884af;border-color: #0884af;padding: 0px 8px;height: 38px;">Go</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
