				...
				<div class="collapse" id="sidebarReport">
				   <ul class="nav nav-collapse">
					  ...
					  <?php
                        ...
                        ?>
                        <li class="@if (Request::Segment(2)=='vw-employeewise-view-payslip') active @endif">
                        <a href="{{url('#')}}">
                        <span class="sub-item">Employee Wise Payslip</span>
                        </a>
                        </li>
                        <?php
                        }else{
                        ...
                        <?php
                            ...
                            ?>
                        <li class="@if (Request::Segment(2)=='vw-employeewise-view-payslip') active @endif">
                        <a href="{{url('payroll/vw-employeewise-view-payslip')}}">
                        <span class="sub-item">Employee Wise Payslip</span>
                        </a>
                        </li>
                        <?php
