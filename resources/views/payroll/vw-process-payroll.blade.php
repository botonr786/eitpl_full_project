            ...
            <div class="col-md-12">
               <div class="card custom-card">
                 @include('layout.message')
                  <div class="card-body">
                    <form action="{{url('payroll/vw-process-payroll')}}" method="post" enctype="multipart/form-data" style="width:50%;margin:0 auto;padding: 18px 20px 18px;background: #ecebeb;">
                        {{ csrf_field() }}
                            ...
                            <input type="hidden" id="deletemy" name="deletemy" class="deletemy" value="@if(isset($month_yr)){{$month_yr}} @endif" />
								<table id="basic-datatables" class="table table-striped table-bordered table-responsive">
									...
									<tfoot>
										...
										<tr>
											<td colspan="7" style="border:none;"><button type="submit" class="btn btn-info btn-sm p-3">Save</button><button type="submit" name="btnDelete" class="btn btn-info btn-sm" style="background-color:red !important;float:right;" onclick="confirmDelete(event);">Delete All Records for the month</button></td>
