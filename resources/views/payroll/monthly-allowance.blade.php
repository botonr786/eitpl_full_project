            ...
            <div class="col-md-12">
               <div class="card custom-card">
                ...
                @include('layout.message')
                  <div class="card-body">
                    <form action="{{url('payroll/vw-montly-allowances')}}" method="post" enctype="multipart/form-data" style="width:50%;margin:0 auto;padding: 18px 20px 18px;background: #ecebeb;">
                        {{ csrf_field() }}
