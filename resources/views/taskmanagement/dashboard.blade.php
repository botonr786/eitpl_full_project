...
<div class="main-panel">
	<div class="pt-3 bg-transparent container">
		<div class="row">
			...
			<!-- <?php
					...
					?> -->
			<div class="col-sm-4">
				<div class="bg-white shadow-sm bg-body-tertiary rounded">
				    <div class="mt-2 ">
					<h6 class="bg-info m-0 p-2 text-white">{{$p->title}}</h6>
				...
				<div class="mb-5 d-block mt-2 p-2">
					@foreach($p->labels as $l)
					<span class="border border-1 rounded pt-1 pb-1 ps-2 pe-2 d-inline-block text-center bg-info text-white">
