                                ...
                                <table id="basic-datatables" class="display table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$p->status}}</td>
                                            <td>
                                                <a href="{{url('/task-management/update-project/'.encrypt($p->id))}}">
                                                    <img style="width: 14px;" src="/assets/img/edit.png">
                                                    </a>
                                                <a href="{{url('projects/del/'.encrypt($p->id))}}" class="text-danger ms-2" onclick="return confirm('Are you sure?')"><i class="fa fa-trash"></i></a>
