...
?>
               ...
               <div class="col-lg-2 col-xl-2 col-md-3 col-sm-6 col-12 pl0 pr0">
                  ...
                  <?php if (in_array("14", $arrrole)) { ?>
                   <a href="{{url('payroll-home-dashboard')}}">
                  <?php } else if (in_array("14", $arrrole_emp)) { ?>
                  <a href="{{url('payroll-home-dashboard')}}">
                  <?php } else { ?>
                  <a href="#">
                  <?php } ?>
               ...
               <div class="col-lg-2 col-xl-2 col-md-3 col-sm-6 col-12 pl0 pr0">
                  <a href="{{url('employeecornerdashboard')}}">
                     <div class="dash-inr">
                        ...
                        <div class="dash-name">Employee Corners</div>
                     </div>
                  </a>
               </div>
...
?>
      ...
      <footer>
         <div class="col-md-12">
            <p>&copy; 2023 CLIMBR - HRMS | All Right Reserved | Developed by <a href="https://eitpl.in/" target="_blank">E.I.T</a></p>
         </div>
      </footer>
      <!-- Optional JavaScript -->
