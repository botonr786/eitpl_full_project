                ...
                if (!sizeof($holidayValidate)) {
                    ...
                    if ($request->type === "logout") {
                        $attendenceId = Attendance::where("date", $date)
                            ...
                            $indiaLocalTime = $currentTime->setTimezone('Asia/Kolkata');
                            
                            $time1 = Carbon::parse($attendenceId->time_in);
                            $time2 = Carbon::parse($indiaLocalTime->toTimeString());
