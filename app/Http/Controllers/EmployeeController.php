...
class EmployeeController extends Controller
{
    public function getamployeedas()
    {
        if (!empty(Session::get("emp_email"))) {
            ...
            $data["employee_data_count"] = DB::table("employee")
                ->where("status", "=", "active")
                ->count();
    ...
    public function employeeblade()
    {
        ...
        $data["bonas"] = DB::table("employee")->where('emid',$Roledata->reg)->get();
    ...
    public function getEmployeeAddFun()
    {
        ...
        $data["DEDUCATION"] = DB::table("rate_masters")
            ...
            $data['employee_eduction']=DB::table('education_master')->get();

            $data['emp_group_by']=DB::table('group_name_details')->get();
    ...
    public function saveEmployeecoedit(Request $request)
    {
        ...
        if ($request->hasFile("traning1_document_upload")) {
            ...
            $pay = [];
            $pay["employee_code"]=$request->input("emp_code");
            $pay["empid"] =$employeeId;
            ...
            // dd($pay);
                  $data= DB::table('employee_pay_structures')->where('empid',$employee_id)
                    ->Delete();
                    // dd($data);
                    DB::table('employee_pay_structures')->insert($pay);
                    if($data==="1"){
                        DB::table('employee_pay_structures')->insert($pay);
                    }
    ...
    <td><input type="text" name="valuededuct[]"  id="valuededuct' .
      ...
      <td><button class="btn-success cmn_bg_style" style="" type="button" id="adddeduct' .
            $rownew .
    ...
    <td><input type="text" name="value_emp[]"  id="value' .
     ...
     <td><button class="btn-success cmn_bg_style" style="" type="button" id="addearn' .
            $rownew .
